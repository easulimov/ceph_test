...
## Настройка взаимодействия keycloak и grafana
...
1. В левом верхнем углу нажимаем на выпадающий список и нажимаем **"Create Realm"**
2. В поле **Realm name** вводим имя реалма, например: ***sea-realm***. Устанавливаем ползунок **Enabled** - ***yes***

Далее, переключаемся на новый realm (выбираем в левом верхнем углу)

Создаем нового клиента

1. В поле *Manage*  нажимаем на **Clients**
2. В поле **Clients list** нажимаем на кнопку **Create client**
3. В открывшемся окне редактируем поля: "General Setting" **"Client type" - "OpenID Connect"**, **"Client ID" - "grafana"**, **"Name" - "grafana"**,